    ...
    const canvas = await html2canvas(card, {
      ...
      onclone: (doc) => {
        ...
        if (name) {
          ...
          name.style.fontFamily             = '"Cairo", "Tajawal", sans-serif';
        }
        ...
        if (role) {
          ...
          role.style.fontFamily             = '"Cairo", "Tajawal", sans-serif';
        ...
        if (kol) {
          ...
          kol.style.fontSize               = '20px';
          kol.style.fontWeight             = '700';
          kol.style.fontFamily             = '"Cairo", "Tajawal", sans-serif';
        }
        ...
        if (gen1name) {
          ...
          gen1name.style.fontSize            = '30px';
          gen1name.style.fontWeight          = '900';
          gen1name.style.fontFamily          = '"Cairo", "Tajawal", sans-serif';
        }
      }
    });
