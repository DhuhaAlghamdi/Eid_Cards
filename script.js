/* =============================================
   MLSAC Eid Generator — style.css  (v2)
   ============================================= */
...
.main-opt:hover .preview-shine {
  left: 100px;
}

.blue-prev { background: linear-gradient(135deg, #001a5c, #0055cc); }
.general-prev { background: linear-gradient(135deg, #881c3c, #d24a73); }
...
.club-texture {
  ...
  inset: 0;
  background:
    radial-gradient(ellipse at 30% 0%, rgba(80,230,255,.12), transparent 50%),
    radial-gradient(ellipse at 70% 100%, rgba(0,120,212,.2), transparent 50%),
    radial-gradient(circle at 90% 20%, rgba(255,255,255,.06), transparent 30%),
    linear-gradient(160deg, #041530 0%, #0a2568 35%, #0d5bc9 70%, #1a78e8 100%);
}
...
.corner-burst::after {
  ...
  background: conic-gradient(
    ...
    rgba(255,255,255,.9) 8deg 12deg,
    rgba(255,255,255,0) 12deg 22deg,
    rgba(255,255,255,.8) 22deg 26deg,
    rgba(255,255,255,0) 26deg 36deg,
    rgba(255,255,255,.92) 36deg 40deg,
    rgba(255,255,255,0) 40deg 50deg,
    rgba(255,255,255,.75) 50deg 54deg,
    rgba(255,255,255,0) 54deg 64deg,
    rgba(255,255,255,.88) 64deg 68deg,
    rgba(255,255,255,0) 68deg 360deg
  );
  filter: drop-shadow(0 0 10px rgba(80,230,255,.4));
...
.burst-left { top: 10px; left: 10px; }
.burst-right { top: 10px; right: 10px; transform: scaleX(-1); }
...
/* ✅ أشكال طراطيع في زوايا بطاقة النادي */
.card-corner-shape {
  position: absolute;
  font-size: 22px;
  opacity: 0.75;
  animation: popTwinkle 3s ease-in-out infinite;
  z-index: 5;
  pointer-events: none;
}
.corner-tl { top: 58px; left: 12px; animation-delay: 0s; }
.corner-tr { top: 58px; right: 12px; animation-delay: 0.5s; }
.corner-bl { bottom: 32px; left: 12px; animation-delay: 1s; }
.corner-br { bottom: 32px; right: 12px; animation-delay: 1.5s; }
...
.club-top {
  ...
  background: linear-gradient(rgba(0,10,38,.8), transparent);
...
.club-logo-img {
  ...
  height: 42px;
  object-fit: contain;
  filter: drop-shadow(0 4px 12px rgba(80,230,255,.3));
}

.club-top-text { text-align: right; }
...
/* ✅ إصلاح club-center — position: absolute بدل center */
.club-center {
  position: absolute;
  inset: 0;
  display: flex;
...
/* ✅ صورة happyeid — invert لتحويل الخط الأسود إلى أبيض */
.club-eid {
  width: 70%;
  filter: drop-shadow(0 8px 24px rgba(0,0,0,.3)) invert(1);
}
...
@keyframes badgeGlow {
  0%, 100% { opacity: .4; }
  50% { opacity: 1; box-shadow: 0 0 16px rgba(80,230,255,.3); }
}
...
@media (max-width: 430px) {
  ...
  .corner-burst { width: 80px; height: 80px; }
  .club-center { padding: 78px 16px 124px; }
  .club-badge { padding: 12px 22px; }
  .hero-balloons { width: 120px; }
  .hero-fireworks { width: 75px; }
}
